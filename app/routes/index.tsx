          ...
          <div className="relative shadow-xl sm:overflow-hidden sm:rounded-2xl">
            <div className="absolute inset-0">
              <img
                ...
                src="shadow-trans-love.png"
                alt="Dog laying on couch, trans flag visible, love sign visible"
              />
              <div className="absolute inset-0 bg-[color:rgba(255,255,255,0.5)] mix-blend-multiply" />
            </div>
            <div className="lg:pb-18 relative px-4 pt-16 pb-8 sm:px-6 sm:pt-24 sm:pb-14 lg:px-8 lg:pt-32">
              <h1 className="text-center text-6xl font-extrabold tracking-tight sm:text-8xl lg:text-9xl">
                <span className="block uppercase text-dark-brown">
                  Working Class Records &reg;
                </span>
              </h1>
